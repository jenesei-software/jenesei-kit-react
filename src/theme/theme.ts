...
export const ThemeLight: ITheme = {
  icon: {
    ...
    map: {
      ...
      checkbox: ['Radio', 'Square', 'Arrow', 'Heart'],
      loading: ['Line', 'Circle', 'Blocks', 'Balls'],
      realebail: ['MapCluster', 'HomeLikes', 'HomeManagement', 'UserSettings', 'User'],
      logo: ['Jenesei', 'BustMarket'],
      bustmarket: ['Card', 'Delivery', 'Heart', 'Reviews', 'Search', 'Menu'],
    },
    getIconId(props) {
