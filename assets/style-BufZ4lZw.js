import{j as a,l as s,f as i,b as n,d,K as u}from"./iframe-DqtU7u_4.js";import{W as m}from"./motion-CvQ3tovE.js";const c=s`
  ${e=>e.$size?f({...u[e.$size],$isErrorAbsolute:e.$isErrorAbsolute}):null};
`,f=e=>s`
  ${e.$isErrorAbsolute?s`
        position: absolute;
        top: calc(100% + 4px);
